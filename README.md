...
- **每周官方套题计划**：周二阅读、周四听力、周六 L/R/W 连续训练、周日口语与错题复盘。Reading 使用 IELTS 官方 Modified Large Print 完整样题（3 篇文章、Questions 1–40 连续编号），每篇文章后直接连接对应题目，40 题统一提交并逐题判分。Listening 明确展示 8 个独立官方 Sample Tasks、共 44 个作答位；每个 Task 全部作答并提交后才解锁对应官方 Tapescript。只有全部必做题提交后，系统才自动记录本套完成。
