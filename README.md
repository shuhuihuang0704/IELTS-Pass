...
- **每周真题计划**：周二阅读、周四听力、周六 L/R/W 连续模考、周日口语与错题复盘；官方 Sample Tasks 已按独立题型切分，默认从 Questions 1 开始。Reading / Listening 配有仿机考电子答题卡，全部作答后统一提交，逐题显示对错与官方答案；同时支持题目与答案 / 范文一键切换、对应录音和倒计时。
...
>
> 真题模块在 App 内加载 IELTS.org 提供的官方原始 [Listening](https://ielts.org/cdn/ielts-sample-tests/ielts-listening-sample-tasks-2023.pdf)、[Reading](https://ielts.org/cdn/Sample-tests/ielts-academic-reading-sample-tasks-2023.pdf)、[Writing](https://ielts.org/cdn/Sample-tests/ielts-academic-writing-sample-tasks-2023.pdf) 与 [Speaking](https://ielts.org/cdn/ielts-sample-tests/ielts-speaking-sample-tasks-2023.pdf) Sample Tasks，并保存本地训练记录。它们是官方公开样题，不标注成 Cambridge 历年真题；商业题库必须获得授权后才能内置。
