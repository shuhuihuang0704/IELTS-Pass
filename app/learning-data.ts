...
export const skills: Array<{
  ...
  { id: "vocabulary", short: "词", label: "词汇综合训练", description: "按备考周期生成高频词速刷、语料听写与连读词组", duration: "按计划" },
  ...
  { id: "speaking", short: "说", label: "口语", description: "真人考官式抽象讨论与追问", duration: "5 分钟" },
];
...
export function getDailyVocabulary(dayKey: string, count = 100) {
  ...
  const start = ((dayNumber % dailyVocabulary.length) * 100) % dailyVocabulary.length;
...
export const listeningExercise = {
  ...
  script:
    "Receptionist: Good morning, Westbridge University Residence. How can I help? Student: Hello. I'm calling to complete my accommodation application. I started the form online, but I wasn't sure about a couple of details. Receptionist: Of course. We can go through it together. Before we begin, have you already received an application number? Student: Yes, it's WR-4086. I wrote it down beside my passport details. Receptionist: That's useful. First, can I take your family name? Student: It's Chen. C, H, E, N. Receptionist: Thank you. Let me just check that on the screen: Chen, C-H-E-N. And is this for the autumn intake? Student: Yes, for the autumn term. I'm hoping to move in before classes start. Receptionist: Right. When will you arrive? Student: On the fourteenth of October. I originally wrote the twelfth, but my flight changed. Receptionist: I see. The fourteenth is fine. Will you need the room for the whole academic year, or only the first term? Student: The whole year, if possible. I may stay during the spring break as well, so I wanted to ask about that. Receptionist: You can remain in the residence during the break, although catering hours are reduced. Do you want a shared room? Student: No, a single room, please. I need somewhere quiet to study. Receptionist: We have single rooms in two buildings. The older block is nearer the library, while the newer block has larger kitchens. Do you have a preference? Student: The library sounds more important. I don't mind using a smaller kitchen. Receptionist: That's noted. Any dietary requirement? Student: Yes, vegetarian. I eat dairy products, but no meat or fish. Receptionist: I'll add that to your catering profile. You can change it later through the student portal, but please give us a week's notice. Receptionist: Now, several facilities are included in the weekly fee. Every room has Wi-Fi, and residents can use the bicycle storage without charge. The laundry is available, but each wash costs three pounds. Breakfast is optional, and I'm afraid there is no gym in this building. There is a small common room on each floor, and the study room has to be booked online. Student: That's fine. What documents do you need? Receptionist: Please send a copy of your passport by email. You can show the original at reception when you arrive. We also need your university offer letter and an emergency contact number. Student: I can email those this evening. Do you need the originals as well? Receptionist: A scanned copy is enough for the application. You can show the original at reception when you arrive, so please keep it in your hand luggage. Receptionist: The deposit must be paid by bank transfer. We cannot accept cash for that, and the reference should include your application number. Student: I understand. Is there a deadline for the transfer? Receptionist: We need the deposit by the thirtieth of September. If your bank takes longer, let us know before then and we can make a note on the application. Student: Right. What time can I collect my key? Receptionist: Check-in begins at three p.m. You said your flight lands at two, so arriving around half past four should be comfortable. The reception desk stays open until seven on weekdays. Student: Great. Is reception open late at the weekend? Receptionist: On Saturdays it's open until five, and on Sundays it closes at four. If you arrive later, email us in advance and the night porter can meet you. Student: Great. I chose Westbridge because it is close to the science building. The city centre residence was newer, but it was much farther from my classes. Receptionist: That makes sense. Before I let you go, check that your phone number and email address are still the same as on the online form. I'll email your confirmation today, together with the move-in checklist. Student: They are both correct. Thanks for taking the time to go through everything. Receptionist: You're welcome. I'll email your confirmation today, and we'll see you in October.",
  formCompletion: [
