...
const artsCentreListening: DailyListeningSet = {
  code: "Daily Set B",
  audioSrc: "/listening-arts-centre.wav?voices=au-female-uk-male-v4",
  captionsSrc: "/listening-arts-centre.vtt?voices=au-female-uk-male-v4",
  voiceLabel: "澳大利亚女课程顾问 × 英国男学员",
  audioCues: {
    l1: { startSeconds: 6.3, endSeconds: 12.6 }, l2: { startSeconds: 13, endSeconds: 18.5 },
    l3: { startSeconds: 18.8, endSeconds: 24.5 }, l4: { startSeconds: 26.1, endSeconds: 32.7 },
    facilities: { startSeconds: 33.1, endSeconds: 46.8 }, l7: { startSeconds: 47.3, endSeconds: 54.6 },
    l8: { startSeconds: 47.3, endSeconds: 54.6 }, l9: { startSeconds: 55, endSeconds: 62.2 },
    l10: { startSeconds: 62.5, endSeconds: 68.4 },
  },
  exercise: {
...
const wildlifeListening: DailyListeningSet = {
  code: "Daily Set C",
  audioSrc: "/listening-wildlife-volunteer.wav?voices=au-female-uk-male-v4",
  captionsSrc: "/listening-wildlife-volunteer.vtt?voices=au-female-uk-male-v4",
  voiceLabel: "澳大利亚女志愿者主管 × 英国男申请者",
  audioCues: {
    l1: { startSeconds: 6.5, endSeconds: 12.4 }, l2: { startSeconds: 12.7, endSeconds: 19.6 },
    l3: { startSeconds: 20, endSeconds: 24.6 }, l4: { startSeconds: 25, endSeconds: 29.8 },
    facilities: { startSeconds: 30.1, endSeconds: 40.3 }, l7: { startSeconds: 40.7, endSeconds: 49.3 },
    l8: { startSeconds: 43.1, endSeconds: 49.3 }, l9: { startSeconds: 49.6, endSeconds: 58.1 },
    l10: { startSeconds: 58.4, endSeconds: 65.3 },
  },
  exercise: {
...
const listeningSets: DailyListeningSet[] = [
  {
    ...
    exercise: listeningExercise,
    evidence: listeningReviewEvidence,
    audioSrc: "/listening-section-1-v2.wav?voices=au-female-uk-male-v4",
    captionsSrc: "/listening-section-1.vtt?voices=au-female-uk-male-v4",
    voiceLabel: "澳大利亚女接待员 × 英国男学生",
    audioCues: {
      l1: { startSeconds: 9.4, endSeconds: 16.7 }, l2: { startSeconds: 17.1, endSeconds: 25.1 },
      l3: { startSeconds: 25.4, endSeconds: 34.4 }, l4: { startSeconds: 34.7, endSeconds: 41.8 },
      facilities: { startSeconds: 42.2, endSeconds: 59.7 }, l7: { startSeconds: 60.1, endSeconds: 74.5 },
      l8: { startSeconds: 63, endSeconds: 74.5 }, l9: { startSeconds: 74.8, endSeconds: 85.7 },
      l10: { startSeconds: 86, endSeconds: 94.9 },
    },
  },
  artsCentreListening,
  wildlifeListening,
