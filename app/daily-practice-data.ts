...
const artsCentreListening: DailyListeningSet = {
  code: "Daily Set B",
  audioSrc: "/listening-arts-centre.wav?voices=au-female-uk-male-v5-spelling",
  captionsSrc: "/listening-arts-centre.vtt?voices=au-female-uk-male-v5-spelling",
  voiceLabel: "澳大利亚女课程顾问 × 英国男学员",
  audioCues: {
    l1: { startSeconds: 6.3, endSeconds: 15.3 }, l2: { startSeconds: 15.6, endSeconds: 21.1 },
    l3: { startSeconds: 21.5, endSeconds: 28.4 }, l4: { startSeconds: 28.7, endSeconds: 35.3 },
    facilities: { startSeconds: 35.7, endSeconds: 49.4 }, l7: { startSeconds: 49.9, endSeconds: 57.2 },
    l8: { startSeconds: 52, endSeconds: 57.2 }, l9: { startSeconds: 57.6, endSeconds: 64.8 },
    l10: { startSeconds: 65.2, endSeconds: 71 },
  },
  exercise: {
...
const wildlifeListening: DailyListeningSet = {
  code: "Daily Set C",
  audioSrc: "/listening-wildlife-volunteer.wav?voices=au-female-uk-male-v5-spelling",
  captionsSrc: "/listening-wildlife-volunteer.vtt?voices=au-female-uk-male-v5-spelling",
  voiceLabel: "澳大利亚女志愿者主管 × 英国男申请者",
  audioCues: {
    l1: { startSeconds: 6.5, endSeconds: 15.5 }, l2: { startSeconds: 15.9, endSeconds: 22.7 },
    l3: { startSeconds: 23.1, endSeconds: 27.7 }, l4: { startSeconds: 28.1, endSeconds: 32.9 },
    facilities: { startSeconds: 33.3, endSeconds: 43.4 }, l7: { startSeconds: 43.9, endSeconds: 52.4 },
    l8: { startSeconds: 46.3, endSeconds: 52.4 }, l9: { startSeconds: 52.8, endSeconds: 61.2 },
    l10: { startSeconds: 61.6, endSeconds: 68.4 },
  },
  exercise: {
...
const listeningSets: DailyListeningSet[] = [
  {
    ...
    exercise: listeningExercise,
    evidence: listeningReviewEvidence,
    audioSrc: "/listening-section-1-v2.wav?voices=au-female-uk-male-v5-spelling",
    captionsSrc: "/listening-section-1.vtt?voices=au-female-uk-male-v5-spelling",
    voiceLabel: "澳大利亚女接待员 × 英国男学生",
    audioCues: {
      l1: { startSeconds: 9.4, endSeconds: 18.8 }, l2: { startSeconds: 19.2, endSeconds: 27.2 },
      l3: { startSeconds: 27.5, endSeconds: 36.5 }, l4: { startSeconds: 36.8, endSeconds: 43.9 },
      facilities: { startSeconds: 44.3, endSeconds: 61.8 }, l7: { startSeconds: 62.2, endSeconds: 76.6 },
      l8: { startSeconds: 65.2, endSeconds: 76.6 }, l9: { startSeconds: 76.9, endSeconds: 87.8 },
      l10: { startSeconds: 88.1, endSeconds: 97 },
    },
  },
  artsCentreListening,
  wildlifeListening,
