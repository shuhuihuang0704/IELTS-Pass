...
const artsCentreListening: DailyListeningSet = {
  ...
  audioCues: {
    ...
    facilities: { startSeconds: 31.2, endSeconds: 44.2 }, l7: { startSeconds: 44.5, endSeconds: 51.4 },
    l8: { startSeconds: 46.5, endSeconds: 51.4 }, l9: { startSeconds: 51.6, endSeconds: 58.6 },
    l10: { startSeconds: 58.8, endSeconds: 64.6 },
  },
  exercise: {
    title: "Community Arts Centre Course Booking",
    subtitle: "Listening Section 1 · Daily Set B",
    script: "Coordinator: Good afternoon, Riverside Arts Centre. How can I help? Caller: Hello. I'd like to book an evening course. I saw the leaflet last week, but I wanted to check a few details before paying. Coordinator: No problem. We can go through it together. Are you looking for an adult class or a course for a child? Caller: An adult class, please. I'm hoping to do something practical after work, rather than another online course. Coordinator: All right. Can I take your surname so I can open a booking record? Caller: Patel. P, A, T, E, L. Coordinator: Thank you. Patel, P-A-T-E-L. I've got that. Which course interests you? Caller: I first considered photography, but I'd prefer pottery. My friend did the photography class last year and recommended the centre. Coordinator: Pottery is quite popular this term. The course starts on the sixth of November, not the fourth as shown in the old leaflet. That earlier date was changed when the tutor became unavailable. Caller: The sixth works for me. How many sessions are there? Coordinator: There are six Wednesday evening sessions. The first one is an introduction to the equipment, and by the final week students usually make a small set of bowls. Caller: That sounds good. I haven't used a wheel before, so I may need a little help at the beginning. Coordinator: That's perfectly normal. The tutor demonstrates each stage, and there are only ten people in the group, so everyone gets a turn. Coordinator: The full fee is eighty-five pounds. The ninety-five-pound figure includes an optional exhibition ticket, so you don't need to choose that unless you want to attend the end-of-term show. Caller: I see. What is included in the course fee? Coordinator: All basic materials are included, and students may use the evening studio without extra charge. Tools can be hired if you want to take extra work home, refreshments are sold downstairs, and parking costs four pounds after five o'clock. Caller: I'll probably come by bus, but it is useful to know about the parking. How will I receive the timetable? Coordinator: We'll email it this afternoon. It includes the room number and a list of materials. Your membership card must be collected at reception before your first class. Caller: Right. I'll look out for the email. What time does the class begin? Coordinator: At six thirty. The building opens at six and the tutor arrives at six fifteen, so you can come early to find your locker. The session normally finishes at eight thirty, with a short break in the middle. Caller: Perfect. Do I need to bring an apron or anything on the first evening? Coordinator: An old shirt is useful, although we provide protective aprons. Please bring your membership card and arrive ten minutes early to sign the safety form. Caller: That's clear. I chose this centre because the classes are small, so I should receive more feedback. The timetable also fits around my work. Coordinator: That makes sense. I'll reserve your place now and email the confirmation, timetable and payment receipt later today. Caller: Thanks very much for your help. Coordinator: You're welcome. We look forward to seeing you in November.",
    formCompletion: [
...
const wildlifeListening: DailyListeningSet = {
  ...
  audioCues: {
    ...
    facilities: { startSeconds: 28.4, endSeconds: 38.2 }, l7: { startSeconds: 38.4, endSeconds: 46.7 },
    l8: { startSeconds: 40.7, endSeconds: 46.7 }, l9: { startSeconds: 46.8, endSeconds: 54.9 },
    l10: { startSeconds: 55, endSeconds: 62 },
  },
  exercise: {
    title: "Wildlife Park Volunteer Registration",
    subtitle: "Listening Section 1 · Daily Set C",
    script: "Supervisor: Good morning, Northwood Wildlife Park. How can I help? Applicant: Hello. I'm calling about the volunteer programme. I read the information online, but I wanted to check the timetable and the application documents. Supervisor: Certainly. We have a few different placements, so I'll ask some questions and then explain the next steps. May I have your surname? Applicant: Morgan. M, O, R, G, A, N. Supervisor: Thank you, Morgan. I've found the form. When can you start? Applicant: The twenty-second of March. I had planned the twentieth, but I have an exam that day, so the later date is the first one I can manage. Supervisor: That's fine. The induction morning is on the twenty-second as well. It takes about two hours, and we'll show you the safety equipment before you meet your supervisor. Supervisor: Which area would you prefer? Applicant: The visitor centre, rather than the cafe. I enjoy speaking to the public, and I already have some experience explaining information to children. Supervisor: Good. The visitor centre can be busy at weekends. Do you have any relevant training? Applicant: Yes, a first-aid certificate. It is still valid, although I can send you an updated copy if necessary. Supervisor: The current certificate is fine. Volunteers receive free lunch and a bus pass for each working day. A uniform is provided after the trial month. Accommodation and bicycle hire aren't available, so you'll need to arrange somewhere to stay and your own transport outside working hours. Applicant: That's helpful. How many days would I normally work each week? Supervisor: Most people do two regular days, but you can request an extra shift during school holidays. The exact rota is agreed after induction, once we know which activities you can support. Applicant: Understood. How should I send my photograph? Supervisor: Upload it through the online form. Please ask your two referees to email their references directly; we cannot accept screenshots or letters handed in by the applicant. Applicant: I'll contact them this evening. Is there anything else I should bring to the induction? Supervisor: Bring photo identification, a notebook and comfortable shoes. We provide the high-visibility vest and a locker, but you should bring a waterproof jacket if the weather is uncertain. Applicant: Right. What is the earliest morning shift? Supervisor: It begins at seven thirty. Staff meet at seven, but volunteers arrive half an hour later. Please use the side entrance because the main gate opens at eight. Applicant: That should be manageable. I'm especially interested in the bird survey because I want practical field experience before university. Supervisor: We run the survey twice a month. I'll note your interest and send the details today, together with the induction checklist. Applicant: Thanks very much. I look forward to hearing from you. Supervisor: You're welcome. We'll be in touch by email.",
    formCompletion: [
...
const listeningSets: DailyListeningSet[] = [
  {
    ...
    audioCues: {
      ...
      facilities: { startSeconds: 40, endSeconds: 56.9 }, l7: { startSeconds: 57.1, endSeconds: 70.8 },
      l8: { startSeconds: 60, endSeconds: 70.8 }, l9: { startSeconds: 70.9, endSeconds: 81.4 },
      l10: { startSeconds: 81.5, endSeconds: 90.5 },
    },
  },
  artsCentreListening,
  wildlifeListening,
